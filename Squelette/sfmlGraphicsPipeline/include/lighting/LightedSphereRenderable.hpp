...
public:
    ...
    LightedSphereRenderable(ShaderProgramPtr prog, bool indexed, const MaterialPtr & mat, unsigned int strips=10u, unsigned int slice=30u, bool vertex_normals=true);
};
