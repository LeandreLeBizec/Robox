...
//    { // Define a DirectionalLight for the whole scene
...
//        glm::vec3 position1 = glm::vec3(10, 10, 0);
//        glm::vec3 position2 = glm::vec3(0, 10, 10);
//        glm::vec3 position3 = glm::vec3(-10, 10, 0);
//        glm::vec3 position4 = glm::vec3(0, 10, -10);
//
//        spotLight->addGlobalTransformKeyframe(lookAtModel(position1, target, glm::vec3(0, 0, -1)), 0);
//        spotLight->addGlobalTransformKeyframe(lookAtModel(position2, target, glm::vec3(0, 0, -1)), 1);
//        spotLight->addGlobalTransformKeyframe(lookAtModel(position3, target, glm::vec3(0, 0, -1)), 2);
//        spotLight->addGlobalTransformKeyframe(lookAtModel(position4, target, glm::vec3(0, 0, -1)), 3);
//        spotLight->addGlobalTransformKeyframe(lookAtModel(position1, target, glm::vec3(0, 0, -1)), 4);
