...
//                                                                    "../../sfmlGraphicsPipeline/shaders/phongFragment.glsl");
    ...
    createPunchingBag(viewer, textureShader, mat, system, systemRenderable);
    camera(viewer);
...
void camera(Viewer& viewer){
    viewer.getCamera().addGlobalTransformKeyframe(lookAtModel(glm::vec3(20,2,-10), glm::vec3(0,4,0), glm::vec3(0,0,-1)), 0.0);
    viewer.getCamera().addGlobalTransformKeyframe(lookAtModel(glm::vec3(10,4,-10), glm::vec3(0,4,0), glm::vec3(0,0,-1)), 2.0);
    viewer.getCamera().addGlobalTransformKeyframe(lookAtModel(glm::vec3(-10,6,-10), glm::vec3(0,4,0), glm::vec3(0,0,-1)), 5.0);
    viewer.getCamera().addGlobalTransformKeyframe(lookAtModel(glm::vec3(-15,8,5), glm::vec3(0,4,0), glm::vec3(0,0,-1)), 7.0);
}
