...
void createAnimateRobox(Viewer& viewer, ShaderProgramPtr& shader, MaterialPtr& mat, DynamicSystemPtr& system, DynamicSystemRenderablePtr &systemRenderable){
    ...
    root->addGlobalTransformKeyframe(GeometricTransformation(getTranslationMatrix(0,4,-0.4) * getRotationMatrix(M_PIf/2.5,1,0,0)), 1);
    root->addGlobalTransformKeyframe(GeometricTransformation(getTranslationMatrix(0,4,-1.1) * getRotationMatrix(M_PIf/2.5,1,0,0)), 3);
    root->addGlobalTransformKeyframe(GeometricTransformation(getTranslationMatrix(0,4,-0.9) * getRotationMatrix(M_PIf/2.5,1,0,0)), 10);

    //Positionnement Bras Gauche
    left_arm->addGlobalTransformKeyframe(GeometricTransformation(getRotationMatrix(M_PIf/2.5,1,0,0) * getRotationMatrix(M_PIf/8,0,-1,0) * getTranslationMatrix(0,0,0.25)), 0.0);
    left_arm->addGlobalTransformKeyframe(GeometricTransformation(getRotationMatrix(M_PIf/6,1,0,0) * getRotationMatrix(M_PIf/8,0,-2,0) * getTranslationMatrix(0,0,0.25)), 3);
    left_arm->addGlobalTransformKeyframe(GeometricTransformation(getRotationMatrix(M_PIf/3,1,0,0) * getRotationMatrix(M_PIf/8,0,-1,0) * getTranslationMatrix(0,0,0.25)), 10);

    left_front_arm->addGlobalTransformKeyframe(GeometricTransformation(getRotationMatrix(M_PIf/4,1,0,0) * getRotationMatrix(M_PIf/8,0,1,0) * getTranslationMatrix(0,0,0.25)), 0.0);
    left_front_arm->addGlobalTransformKeyframe(GeometricTransformation(getRotationMatrix(M_PIf/4,1,0,0) * getRotationMatrix(M_PIf/5,0,1,0) * getTranslationMatrix(0,0,0.25)), 1.0);
    left_front_arm->addGlobalTransformKeyframe(GeometricTransformation(getRotationMatrix(M_PIf/2,1,0,0) * getRotationMatrix(M_PIf/5,0,1,0) * getTranslationMatrix(0,0,0.25)), 3);
    left_front_arm->addGlobalTransformKeyframe(GeometricTransformation(getRotationMatrix(M_PIf/3.5,1,0,0) * getRotationMatrix(M_PIf/5,0,1,0) * getTranslationMatrix(0,0,0.25)), 10);

    //Positionnement Bras Droite
    right_arm->addGlobalTransformKeyframe(GeometricTransformation(getRotationMatrix(M_PIf/2.5,1,0,0) * getRotationMatrix(M_PIf/8,0,1,0) * getTranslationMatrix(0,0,0.25)), 0.0);
    right_arm->addGlobalTransformKeyframe(GeometricTransformation(getRotationMatrix(M_PIf/6,1,0,0) * getRotationMatrix(M_PIf/8,0,2,0) * getTranslationMatrix(0,0,0.25)), 3);
    right_arm->addGlobalTransformKeyframe(GeometricTransformation(getRotationMatrix(M_PIf/3,1,0,0) * getRotationMatrix(M_PIf/8,0,2,0) * getTranslationMatrix(0,0,0.25)), 10);

    right_front_arm->addGlobalTransformKeyframe(GeometricTransformation(getRotationMatrix(M_PIf/4,1,0,0) * getRotationMatrix(-M_PIf/8,0,1,0) * getTranslationMatrix(0,0,0.25)), 0.0);
    right_front_arm->addGlobalTransformKeyframe(GeometricTransformation(getRotationMatrix(M_PIf/4,1,0,0) * getRotationMatrix(-M_PIf/5,0,1,0) * getTranslationMatrix(0,0,0.25)), 1.0);
    right_front_arm->addGlobalTransformKeyframe(GeometricTransformation(getRotationMatrix(M_PIf/2,1,0,0) * getRotationMatrix(-M_PIf/5,0,1,0) * getTranslationMatrix(0,0,0.25)), 3);
    right_front_arm->addGlobalTransformKeyframe(GeometricTransformation(getRotationMatrix(M_PIf/3.5,1,0,0) * getRotationMatrix(-M_PIf/5,0,1,0) * getTranslationMatrix(0,0,0.25)), 10);
}
...
void createAnimateRock(Viewer& viewer, ShaderProgramPtr& shader, MaterialPtr& mat){
    ...
    //Animation du rocher
    rock->addGlobalTransformKeyframe(GeometricTransformation(getTranslationMatrix(0,4,-13) * getRotationMatrix(M_PIf/2.5,1,0,0) * getScaleMatrix(4.5, 4.5, 4.5)), 0.0);
    rock->addGlobalTransformKeyframe(GeometricTransformation(getTranslationMatrix(0,4,-13) * getRotationMatrix(M_PIf/2.5,1,0,0) * getScaleMatrix(4.5, 4.5, 4.5)), 3.0);
    rock->addGlobalTransformKeyframe(GeometricTransformation(getTranslationMatrix(0,4,-13.5) * getRotationMatrix(M_PIf/2.5,1,0,0) * getScaleMatrix(4.5, 4.5, 4.5)), 10);
...
void camera(Viewer& viewer){
    viewer.getCamera().addGlobalTransformKeyframe(lookAtModel(glm::vec3(-20,6,-10), glm::vec3(0,4,0), glm::vec3(0,0,-1)), 0.0);
    viewer.getCamera().addGlobalTransformKeyframe(lookAtModel(glm::vec3(-16,6,-8), glm::vec3(0,4,0), glm::vec3(0,0,-1)), 5.0);
    viewer.getCamera().addGlobalTransformKeyframe(lookAtModel(glm::vec3(-12,6,-6), glm::vec3(0,4,0), glm::vec3(0,0,-1)), 10.0);
}
